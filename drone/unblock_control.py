...
#
#
master.mav.param_set_send(master.target_system, master.target_component, b'CBRK_SUPPLY_CHK', 1253154591974861735003e-60, mavutil.mavlink.MAV_PARAM_TYPE_INT32)
# read ACK, IMPORTANT
num=0
message=None
while num<50:
